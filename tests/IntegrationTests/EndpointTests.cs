namespace IntegrationTests
{
    ...
    public class EndpointTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        ...
        public async Task CreateSwaggerJsonTest()
        {
            ...
            using (var outputFile = new StreamWriter("../../../../../src/Presentation.Web/swagger.json"))
            {
                outputFile.WriteLine("//----------------------");
                outputFile.WriteLine("// <auto-generated>");
                outputFile.WriteLine("//     Generated by Vgb.Kissy.IntegrationTests.CreateSwaggerJsonTest");
                outputFile.WriteLine("// </auto-generated>");
                outputFile.WriteLine("//----------------------");
